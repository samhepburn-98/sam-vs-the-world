...
import type { GameRef, WriteIntent } from "@/lib/rally/write-intent"

// The write contract lives in lib/rally so the data-access layer can execute
// intents without importing this planner; re-exported here for the logger's
// own consumers.
export type { GameRef, WriteIntent }
