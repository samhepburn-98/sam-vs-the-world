...
// (#17) layer onto this surface. All session mutations run through the pure
// planner in logger/lib/session — this component maps its write intents onto
// the FIFO queue and renders the result.
