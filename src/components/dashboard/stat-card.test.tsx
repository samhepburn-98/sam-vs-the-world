...
describe("StatCard", () => {
  it("always shows a rate beside its denominator", () => {
    render(<StatCard label="Win rate" rate={{ won: 15, of: 22 }} minSample={5} />)
  ...
  it("renders a plain count with its unit, no percent sign", () => {
    render(<StatCard label="Errors" value={3.4} unit="per game" sample={9} minSample={5} />)
  ...
  it("gates a plain value on its own sample", () => {
    render(<StatCard label="Errors" value={3.4} unit="per game" sample={2} minSample={5} />)
