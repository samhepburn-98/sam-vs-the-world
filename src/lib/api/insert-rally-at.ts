...
export async function insertRallyAt(row: RallyRow) {
...
type UseInsertRallyAtOptions = {
  mutationConfig?: MutationConfig<typeof insertRallyAt>
}

export function useInsertRallyAt({
  mutationConfig,
}: UseInsertRallyAtOptions = {}) {
