...
export default [
  ...
  },
  {
    ...
    ignores: [
      // Git worktrees live under .claude/ and carry their own config files —
      // a worktree's eslint.config.js is a .js file the TanStack presets'
      // `files` globs don't match but our unscoped `rules` object does, which
      // fails the whole run with "plugin import not defined". Local-only, so
      // CI never saw it.
      ".claude/**",
      "eslint.config.js",
      ".prettierrc",
